...
const Modal = ({ setModal }: IProps) => {
  ...
  return (
    <div className={styles.modal__backdrop} onClick={() => setModal(false)}>
      <div className={styles.modal__content}>
        <button className={styles.modal__button} onClick={() => signIn()}>
          <svg viewBox="0 0 250 243.83" width="26" height="26">
            <path
          ...
          <span className={styles.modal__text}>Log In with GitHub</span>
        </button>
      </div>
    </div>
  );
